...
function getV3Code({ code, version, path }) {
  self.importScripts(`https://d1ks0e82elkklw.cloudfront.net/svelte@${version}/compiler.js`);
...
function getV2Code({ code, version, path }) {
  self.importScripts(`https://d1ks0e82elkklw.cloudfront.net/svelte@${version}/compiler/svelte.js`);
